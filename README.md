...
(80/180 images, `2026-07-17-concept-art-dataset-foxgirl/dataset/<feature>-sNN.webp`);
...
Tree depth is capped at `session/category/file`; nested groupings are
encoded in hyphenated filename prefixes (e.g.
